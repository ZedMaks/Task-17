...
function addPlatforms() {
  ...
  platforms.create(50, 415, 'platform');
  ...
  platforms.create(700, 460, 'platform2');
...
window.onload = function () {
  game = new Phaser.Game(850, 600, Phaser.AUTO, '', { preload: preload, create: create, update: update, render: render });
  ...
  function update() {
    ...
    if (won) {
      winningMessage.text = "NICE, YOU WIN)";
    }
  }
  function render() {
